...
export default function Jeu2({ navigation }) {
  ...
  const sourceConsigne = getImage('Jeux210/Bulle')
  ...
  const saveData = async () => {
    ...
    if (score > bestScore) {
      AsyncStorage.setItem("bestScore2", JSON.stringify(score))
      setBestScore(score)
    }
  ...
  useEffect(() => {
    ...
    if(idQuestion>=0){
      console.log(questions[idQuestion])
      setReponses([
        questions[idQuestion].reponseVraie+"",
        questions[idQuestion].reponseFausse1+"",
        questions[idQuestion].reponseFausse2+""
      ...
      <View style={[styles.container, {
        ...
        <View style={styles.gateauxContainer}>
          <Gateau
            ...
            anim4={anim4}
            anim5={anim5}
            trueResponse={idQuestion>=0 && questions!==null ? reponses[0] == questions[idQuestion].reponseVraie : false}
            faux={gateauxFaux[0]}
          ...
          <Gateau
            ...
            anim4={anim4}
            anim5={anim5}
            trueResponse={idQuestion>=0 && questions!==null?  reponses[1] == questions[idQuestion].reponseVraie : false}
            faux={gateauxFaux[1]}
          ...
          <Gateau
            ...
            anim4={anim4}
            anim5={anim5}
            trueResponse={idQuestion>=0 && questions!==null? reponses[2] == questions[idQuestion].reponseVraie : false}
            faux={gateauxFaux[2]}
          ...
          >
            ...
            <TouchableOpacity
              onPress={async() => {
                ...
                await stopSounds()
                await  ScreenOrientation.lockAsync(ScreenOrientation.OrientationLock.PORTRAIT_UP)
                await navigation.navigate('JeuxCompta')
              }}
              style={{
                position: "absolute",
                width: "30%",
